    ...
    >
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {[
          ...
          { id: "dyeing", label: "Dyeing Yarn" },
          { id: "trimming", label: "Trimming Yarn" },
          { id: "admin", label: "Admin Yarn Overview" },
        ].map((btn) => (
          <motion.button
            key={btn.id}
          ...
          {records.map((rec, index) => (
            ...
            >
              ...
              <div className="p-6 text-gray-700 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-y-3">
                ...
                <p><strong>Available Yarn:</strong> {rec.available_yarn ?? "—"}</p>
                <p><strong>Processed Yarn:</strong> {rec.processed_yarn ?? "—"}</p>
